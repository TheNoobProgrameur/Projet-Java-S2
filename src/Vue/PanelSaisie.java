...
/**
 * panel de saisie ou l'on creer un graphe à afficher
 * @author fahem et Antoine_Berthier
 *
 */

public class PanelSaisie extends JPanel implements ActionListener,Serializable {
	
	DonneesGraphe graphe = new DonneesGraphe(null, null, null);
	GridBagLayout gestionnaireGrid = new GridBagLayout();
	GridBagConstraints contrainte = new GridBagConstraints();
	
	private boolean nouv = false;

	JLabel nomGraphe = new JLabel("nom du graphe");
	JTextField chNomGraphe = new JTextField();
	
	JLabel nomX = new JLabel("nom abscisses");
	JTextField chNomX = new JTextField();
	
	JLabel nomY = new JLabel("nom ordonnée");
	JTextField chNomY = new JTextField();
	...
	/**
	 * Constructeur de la page de saisie.
	 * @param parFM
	 * @param parGraphe
	 */
	public PanelSaisie(JFrame parFM,PanelContentPane panel){
		...
		contrainte.gridx = 6;
		this.add(nomGraphe,contrainte);//nom du graphe
		
		contrainte.gridx = 1;
		contrainte.gridy = 0;		
		this.add(chNomGraphe,contrainte);
		...
		this.add(nomX,contrainte);//nom axe x
		
		contrainte.gridx = 1;
		contrainte.gridy = 1;
		//contrainte.gridwidth = 2;
		this.add(chNomX,contrainte);
		...
		contrainte.gridy = 2;
		//contrainte.gridwidth = 1;
		this.add(nomY,contrainte);//nom axe y
		
		contrainte.gridx = 1;
		contrainte.gridy = 2;
		//contrainte.gridwidth = 2;
		this.add(chNomY,contrainte);
...
/**
 * Constructeur pour la JOptionPanel de la fenetreMere
 * @param panel
 */
public PanelSaisie(PanelContentPane panel) {
 ...
 * ajoute des points dans les series a chaque pression et créer un obj graphe dès qu'un
 * bouton est pressé.
 */
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() == ajouter){
			...
			graphe.setNomGraphe(chNomGraphe.getText());
			graphe.setNomX(chNomX.getText());
			graphe.setNomY(chNomY.getText());
			MethodePourFichier.ecriture(new File("Fichier_obj/"+chNomGraphe.getText()), graphe);
			if(nouv == false){
...
public JLabel getNomGraphe() {
	return nomGraphe;
}


public void setNomGraphe(JLabel nomGraphe) {
	this.nomGraphe = nomGraphe;
}


public JTextField getChNomGraphe() {
	return chNomGraphe;
}


public void setChNomGraphe(JTextField chNomGraphe) {
	this.chNomGraphe = chNomGraphe;
}


public JLabel getNomX() {
	return nomX;
}


public void setNomX(JLabel nomX) {
	this.nomX = nomX;
}


public JTextField getChNomX() {
	return chNomX;
}


public void setChNomX(JTextField chNomX) {
	this.chNomX = chNomX;
}


public JLabel getNomY() {
	return nomY;
}


public void setNomY(JLabel nomY) {
	this.nomY = nomY;
}


public JTextField getChNomY() {
	return chNomY;
}


public void setChNomY(JTextField chNomY) {
	this.chNomY = chNomY;
}
